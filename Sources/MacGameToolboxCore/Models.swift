...
public struct MetalHUDElement: Sendable, Equatable {
    ...
    public init(raw: String, zh: String, en: String, hintZh: String, hintEn: String) {
        self.raw = raw
        self.zh = zh
        self.en = en
        self.hintZh = hintZh
    ...
    public static let allElements: [MetalHUDElement] = [
        ...
        MetalHUDElement(raw: "metalcpu", zh: "命令缓冲区与编码器", en: "Command Buffer & Encoder Count",
        ...
        MetalHUDElement(raw: "toplabeledcommandbuffers", zh: "顶部标记命令缓冲区", en: "Top Labeled Command Buffers",
        ...
        MetalHUDElement(raw: "toplabeledencoders", zh: "顶部标记编码器", en: "Top Labeled Encoders",
